...
- **Проблемы коллизии**
    - У горизонтальных полигонов нет коллизии.
    - Персонаж не может передвигаться после обновления системы физики.
...
-   **Коллизия карты (`nine/core/world.py`):**
    ...
    -   `CollisionPolygon` для точной коллизии по треугольникам (1580+ полигонов)
