...
| NPC AI | ✅ Работает | LOD, патруль, вандер, потребности→поведение, черты→модификаторы, расписания |
| NPC Модели | ✅ Работает | Shared Mixamo animations, MODEL_FILE_MAP для разных моделей |
